...
\usepackage[
style=verbose-ibid, % Boilerplate style which uses author-year style citations and bib-entries
autocite=footnote,
...
\setlength{\parindent}{0.5in}       % Don't indent paragraphs
...
\deffootnote[0.5in]{0em}{1em}{\thefootnotemark.\ }

% blank lines between footnotes (chicago)
