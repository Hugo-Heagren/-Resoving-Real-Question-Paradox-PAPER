% You're using 'Wn-1'. You need subscripts.
...
The answer to \ref{Qf2} will provide all the information the answer to Qf1 would have (that is, it will tell us A1) \emph{and} will  then tell us why that is the case.
...
Each question tell us what it's predecessor would have, as well as why that is the case.
...
For example if we begin with a simple practical question like `When is the best time to check your car's oil?', then the reason W100 might just be an appeal to physical law, and W101 a similar appeal to a more general law which governs the first.
The difference in value between W100 and W101 (and thus the difference in value between Qf100 and Qf101) will be much smaller than an earlier difference (e.g.\ between Qf1 and Qf2).
