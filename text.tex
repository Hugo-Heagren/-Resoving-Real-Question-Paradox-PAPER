...
In Markosian \autocite[]{Markosian_1997}, a paradox is presented.
...
\footnotetext{I follow the numbering of other's cited works throughout, and they mostly follow \autocite[]{Markosian_1997}.}
...
In \autocite[]{Sider1997}, Sider solves the paradox: the presumption that there is a best question has produced a contradiction (that \ref{Q4} is and is not the best question), so by \textit{reductio} there is no best question.
...
This is the notion of best that we most often employ, and it very similar to my solution to the paradox: though the runner is never strictly \emph{the} best, they are still so good that for you or me they may as well be.
